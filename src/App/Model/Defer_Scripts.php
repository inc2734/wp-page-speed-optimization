...
class Defer_Scripts {
	...
	public function __construct() {
		...
		$has_before_handles      = array();
		$has_before_handles_deps = array();
		$has_after_handles       = array();
		$has_after_handles_deps  = array();
		...
		if ( $this->_is_sync_jquery() ) {
			$this->handles = array_diff( $this->handles, array( 'jquery', 'jquery-core' ) );
		}
	}
	...
	protected function _remove( $handle ) {
		...
		$this->handles             = array_diff( $this->handles, array( $handle ) );
